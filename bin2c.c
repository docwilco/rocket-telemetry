 ...
 * 
 * And I (DocWilco <github@drwil.co>) have made some modifications to it
 * to make it work with ESPAsyncWebServer.
 */
...
main(int argc, char *argv[])
{
    ...
    fprintf(f_output, "const uint8_t %s[%i] = {", ident, file_size);
